...
import { Download, Loader2, MessageSquare, RotateCcw, Share2 } from "lucide-react";
      ...
      <header className="sticky top-0 z-50 border-b border-[#64748B]/20 bg-[#F2F2F2]/94 backdrop-blur-md shadow-sm">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            <Button className="bg-[#1E3A8A] hover:bg-[#1E293B] text-white" onClick={() => navigate("/input")}>
