...
Round 3에서는 최종 판단 전에 사업 관점의 결론을 4~7문장으로 정리하세요.
Round 1·2와 사용자 추가 질문을 모두 반영하고, 실행 가능 조건 1개, 양보하면 안 되는 사업 가치 1개, 사용자가 바로 확인할 문서나 조항 1개를 포함하세요.
새로운 쟁점 나열은 금지하고, 최종 판정관이 결론을 낼 때 참고할 사업상 우선순위를 분명히 말하세요.
""" + _BUBBLE_STYLE
